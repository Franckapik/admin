...
const Index = (props) => {
	...
	/* 	const { response: ganalytics } = useFetch('/ga/auth/google')
				...
				<Row>
					<Col xl="4">
						<Card className="shadow">
							<CardHeader className="bg-transparent">Header</CardHeader>
							<CardBody>analyittics</CardBody>
						</Card>
					</Col>
				</Row>
				<Row>
